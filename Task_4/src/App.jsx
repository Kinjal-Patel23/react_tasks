    ...
    <div className="min-h-screen flex flex-col gap-2 items-center justify-center bg-linear-to-r from-pink-300 via-purple-500 to-blue-300">
          ...
          <div>
            ...
            <div className="flex gap-6">
              <label className="flex items-center gap-2">
                <input type="radio" name="gender" value="Male" className="accent-purple-500" onChange={handleInput} />
                Male
              </label>

              <label className="flex items-center gap-2">
                <input type="radio" name="gender" value="Female" className="accent-purple-500" onChange={handleInput} />
                Female
              </label>
            </div>
          </div>
          ...
          <div>
            ...
            {["React js", "Node js", "Express js", "MongoDB"].map((skill) => (
              <label key={skill} className="block">
                <input type="checkbox" name="skills" value={skill} onChange={handleInput} />{" "}
                {skill}
              </label>
            ))}
          </div>
      ...
      {submitData && (
        <div className="ml-8 bg-white p-6 rounded-xl shadow-lg">
          ...
          <p><strong>Skills:</strong> {submitData.skills.join(", ")}</p>
        </div>
      )}
    </div>
